...
const CadastroUsuariosCreate = () => {
    ...
    const [textErroFabricanteClass, setTextErroFabricanteClass] = useState("show");
    const [textErroModeloClass, setTextErroModeloClass] = useState("show");
    const [textErroIpClass, setTextErroIpClass] = useState("show");
    const [textErroDeptoClass, setTextErroDeptoClass] = useState("show");

    /* VARIVAEIS AUXILIARES */
    const [okIP, setOkIP] = useState(false);
    ...
    const handleSubmit =  async (e) => {
      ...
      try {
        ...
        switch(erro){
          ...
          case 2:
            /* caso 0 é que EXISTE somente NOME */
            setTextErroNome("Nome já existe");
            setTextErroNomeClass("Show");
            setOkIP(false);
          break;
          ...
          case 3:
            /* caso 0 é que EXISTE somente IP */
            setTextErroIp("IP já existe");
            setTextErroIpClass("Show");
            setOkIP(false);
          break;
      ...
      if(nome && fabricante && modelo && okIP &&  grupoDepto.length > 0) {
        ...
        try {
          const response = await printerCreate(dadosParaEnviar);
                setMsg(response.msg)
